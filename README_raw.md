// NOTE: This is the "raw" version of the README.md file. It is processed by a markdown enhancer tool to automatically generate the final README.md file.
...
# The *node-red-typescript-boilerplate* command line tool
